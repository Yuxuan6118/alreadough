  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <h1>素材与版权说明</h1>
        <p>AlreaDough 的愿景板坚持使用真实素材。自动找图只应呈现许可允许相应使用的来源，并展示作者、原始页面和许可信息。图片版权仍属于原作者；图片出现在搜索结果或愿景板中不代表作者为 AlreaDough 或用户背书。</p>
        <h2>授权素材</h2>
