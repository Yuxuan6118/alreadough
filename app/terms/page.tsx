  ...
  return (
    <main className="legal-page">
      ...
      <article>
        ...
        <h1>测试版使用条款</h1>
        <p>Already 当前为私人测试产品。本页用于让测试者在使用前理解产品边界，不构成正式公开发行版本的最终法律条款。正式开放注册或收费前，将补充运营主体、联系地址、适用地区、退款及争议处理信息。</p>
        <h2>适用年龄与服务性质</h2>
        <p>测试版仅面向年满 18 岁的用户。Already 提供 AI 对话、想象练习、故事、Revision、声音练习与愿景板工具，不提供医疗、心理治疗、法律、财务或危机服务，也不承诺任何特定外部结果或发生时间。</p>
        <h2>用户内容与现实行为</h2>
        <p>你保留自己输入、录制和上传内容中依法享有的权利，并确认有权使用这些内容。不得利用 Already 实施违法、侵权、跟踪、骚扰、冒充、强迫、泄露隐私或伤害行为。AI 对愿望的支持不等于对任何现实手段的授权。</p>
        <h2>AI 与可用性</h2>
